...
import com.example.quizapp.databinding.ActivityQuestion3Binding
...
class Question3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnQuestion1Choice2.setOnClickListener { correctAnswer(myScore) }
    ...
    private fun correctAnswer(myScore: Int) {
        ...
        toast.show()
        //Switch Activity
        val myIntent = Intent(this, Question4Activity::class.java)
