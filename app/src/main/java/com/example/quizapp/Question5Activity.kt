...
import com.example.quizapp.databinding.ActivityQuestion5Binding
...
class Question5Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnQuestion1Choice4.setOnClickListener { correctAnswer(myScore) }
    }
    private fun correctAnswer(myScore: Int) {
        ...
        toast.show()
        //Switch Activity
        val myIntent = Intent(this, Question6Activity::class.java)
